...
export class SidebarComponent {
  ...
  private readonly menuByRole: Record<string, MenuItem[]> = {
    ...
    ANALYSTE: [
      ...
      { label: 'Pipeline Airflow', icon: 'account_tree', route: '/analyste/pipeline' },
      { label: 'Drift ML',         icon: 'trending_up',  route: '/analyste/drift' },
    ],
    DIRECTEUR: [
      { label: 'Dashboard',        icon: 'dashboard',       route: '/directeur/dashboard' },
      { label: 'Alertes ML',       icon: 'warning_amber',   route: '/directeur/alertes' },
      ...
      { label: 'Utilisateurs',     icon: 'manage_accounts', route: '/directeur/equipe' },
    ...
    SUPER_ADMIN: [
      { label: 'Dashboard Plateforme', icon: 'domain',      route: '/platform/dashboard' },
    ...
    RESPONSABLE_RECOUVREMENT: [
      { label: 'Dashboard',       icon: 'dashboard',  route: '/recouvrement/dashboard' },
      { label: 'Créances',        icon: 'account_balance', route: '/recouvrement/creances' },
      { label: 'Actions',         icon: 'task_alt',   route: '/recouvrement/actions' },
      { label: 'Alertes',         icon: 'warning_amber', route: '/recouvrement/alertes' },
    ],
    CHEF_AGENCE: [
      { label: 'Dashboard Agence',     icon: 'dashboard',     route: '/chef-agence/dashboard' },
      { label: 'Dossiers Crédit',      icon: 'folder_open',   route: '/chef-agence/dossiers' },
      { label: 'Mon Équipe',           icon: 'groups',        route: '/chef-agence/equipe' },
    ],
    AGENT_CREDIT: [
      { label: 'Dashboard',       icon: 'dashboard',   route: '/credit/dashboard' },
      { label: 'Nouveau Dossier', icon: 'add_circle',  route: '/credit/nouveau-dossier' },
      { label: 'Mes Dossiers',    icon: 'folder_open', route: '/credit/dossiers' },
    ],
    ANALYSTE_ENGAGEMENTS: [
      { label: 'Conformité COBAC', icon: 'verified',     route: '/engagements/conformite' },
      { label: 'Dossiers',         icon: 'folder_open',  route: '/engagements/dossiers' },
    ],
    AGENT_SAISIE: [
      { label: 'Contrats',  icon: 'description', route: '/saisie/contrats' },
    ],
    CAISSIER: [
      { label: 'Tableau de bord',  icon: 'dashboard',       route: '/caisse/dashboard' },
      { label: 'Décaissement',     icon: 'payments',        route: '/caisse/decaissement' },
      { label: 'Encaissement',     icon: 'account_balance_wallet', route: '/caisse/encaissement' },
    ],
    SUPPORT: [
      { label: 'Tickets',          icon: 'confirmation_number', route: '/support/tickets' },
      { label: 'Monitoring',       icon: 'monitor_heart',       route: '/support/monitoring' },
  ...
  toggle() { this.collapsed.update((v: boolean) => !v); }
}
