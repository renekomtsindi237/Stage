...
const routes: Routes = [
  ...
  },
  {
    path: 'admin/alertes',
    canActivate: [AuthGuard, RoleGuard],
    data: { roles: ['DIRECTEUR', 'RESPONSABLE_RECOUVREMENT', 'ANALYSTE', 'DSI'] },
  ...
  },
  {
    ...
    canActivate: [AuthGuard, RoleGuard],
    data: { roles: ['DIRECTEUR', 'RESPONSABLE_RECOUVREMENT', 'ANALYSTE', 'DSI'] },
    loadChildren: () => import('./modules/prets/prets.module').then(m => m.PretsModule)
  },
  {
    path: 'admin/clients',
    canActivate: [AuthGuard, RoleGuard],
  ...
  },
  {
    ...
    canActivate: [AuthGuard, RoleGuard],
    data: { roles: ['DIRECTEUR', 'RESPONSABLE_RECOUVREMENT', 'ANALYSTE', 'DSI'] },
    loadChildren: () => import('./modules/recouvrement/recouvrement.module').then(m => m.RecouvrementModule)
  },
  {
    path: 'admin/kyc',
    canActivate: [AuthGuard, RoleGuard],
