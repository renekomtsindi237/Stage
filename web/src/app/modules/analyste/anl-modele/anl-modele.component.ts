...
export class AnlModeleComponent implements OnInit {
  ...
  readonly lineOptions: ChartOptions<"line"> = {
    ...
    plugins: { legend: { display: false },
      annotation: { annotations: {
        seuilAttn: { type: "line", yMin: 0.10, yMax: 0.10, borderColor: "#f59e0b", borderWidth: 2, borderDash: [6, 4] },
        seuilDrift: { type: "line", yMin: 0.20, yMax: 0.20, borderColor: "#dc2626", borderWidth: 2, borderDash: [6, 4] },
      }},
    } as any,
  ...
  getStatutClass(s: string): string {
    return { STABLE: "badge-ok", ATTENTION: "badge-warn", DERIVE: "badge-alert" }[s] ?? "";
  }
  getStatutLabel(s: string): string {
    return { STABLE: "STABLE", ATTENTION: "ATTENTION", DERIVE: "DÉRIVE DÉTECTÉE" }[s] ?? s;
  }
}
