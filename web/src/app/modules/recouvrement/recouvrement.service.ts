...
export class RecouvrementService {
  ...
  ouvrirDossier(req: OuvrirDossierRequest): Observable<DossierRecouvrementResponse> {
    return this.http.post<ApiResponse<DossierRecouvrementResponse>>(`${this.API}/dossiers`, req)
      .pipe(map(r => r.data));
  }
  ...
  listDossiers(
    ...
    return this.http.get<ApiResponse<PageResponse<DossierRecouvrementResponse>>>(
      `${this.API}/dossiers`, { params }
    ).pipe(map(r => r.data));
  }

  getDossier(id: number): Observable<DossierRecouvrementResponse> {
    return this.http.get<ApiResponse<DossierRecouvrementResponse>>(`${this.API}/dossiers/${id}`)
      .pipe(map(r => r.data));
  }

  escalader(id: number, req: EscaladerDossierRequest): Observable<DossierRecouvrementResponse> {
    return this.http.put<ApiResponse<DossierRecouvrementResponse>>(
  ...
  ajouterAction(dossierId: number, req: AjouterActionRequest): Observable<ActionRecouvrementResponse> {
    return this.http.post<ApiResponse<ActionRecouvrementResponse>>(
      `${this.API}/dossiers/${dossierId}/actions`, req
    ).pipe(map(r => r.data));
  }

  getActions(dossierId: number): Observable<ActionRecouvrementResponse[]> {
    return this.http.get<ApiResponse<ActionRecouvrementResponse[]>>(
  ...
  creerAccord(dossierId: number, req: AccordReechelonnementRequest): Observable<AccordReechelonnementResponse> {
    return this.http.post<ApiResponse<AccordReechelonnementResponse>>(
      `${this.API}/dossiers/${dossierId}/accords`, req
    ).pipe(map(r => r.data));
  }

  getAccords(dossierId: number): Observable<AccordReechelonnementResponse[]> {
    return this.http.get<ApiResponse<AccordReechelonnementResponse[]>>(
