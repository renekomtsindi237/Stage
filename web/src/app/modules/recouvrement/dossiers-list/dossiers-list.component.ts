...
export class DossiersListComponent implements OnInit {
  ...
  readonly phaseOptions: Array<{ value: RecouvrementPhase | ''; label: string }> = [
  ...
  readonly displayedColumns = [
    'idPret', 'montantImpaye', 'joursRetard', 'categorieCobtac', 'phase', 'frais', 'clos', 'actions'
  ];
  ...
  loadDossiers(): void {
    this.loading = true;
    this.error = '';
    this.recouvrementService.listDossiers(
