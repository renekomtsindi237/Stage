...
export class DossierDetailComponent implements OnInit {
  ...
  readonly typeActionOptions: Array<{
    value: TypeActionRecouvrement;
    label: string;
    group: string;
  }> = [
    {
    ...
    {
      value: "CONTACT_CAUTION",
      label: "Contact caution solidaire",
      group: "Terrain",
    },
    {
      value: "MEDIATION_CHEF_QUARTIER",
      label: "Médiation chef de quartier",
      group: "Médiation",
    },
    {
      value: "MEDIATION_FAMILLE",
      label: "Médiation famille",
      group: "Médiation",
    },
    {
      value: "ENCAISSEMENT_PARTIEL",
      label: "Encaissement partiel",
      group: "Paiement",
    },
    {
      value: "ENCAISSEMENT_TOTAL",
      label: "Encaissement total",
      group: "Paiement",
    },
    {
      value: "MISE_EN_DEMEURE_LETTRE",
      label: "Lettre de mise en demeure",
      group: "Judiciaire",
    },
    {
      value: "INTERVENTION_HUISSIER",
      label: "Intervention huissier",
      group: "Judiciaire",
    },
    {
      value: "ASSIGNATION_TRIBUNAL",
      label: "Assignation tribunal (OHADA)",
      group: "Judiciaire",
    },
    { value: "SAISIE_GARANTIE", label: "Saisie garantie", group: "Judiciaire" },
    {
      value: "COMITE_RECOUVREMENT",
      label: "Comité de recouvrement",
      group: "Interne",
    },
    {
      value: "ACCORD_REECHELONNEMENT",
      label: "Accord de rééchelonnement",
      group: "Interne",
    },
  ...
  creerAccord(): void {
    ...
    this.recouvrementService.creerAccord(this.dossier.id, req).subscribe({
      next: (a) => {
        ...
        this.accords.forEach((acc, i) => {
          if (i > 0) acc.actif = false;
        });
  ...
  isMomoAction(): boolean {
    return ["ENCAISSEMENT_PARTIEL", "ENCAISSEMENT_TOTAL"].includes(
      this.actionForm.get("typeAction")?.value,
    );
  }
