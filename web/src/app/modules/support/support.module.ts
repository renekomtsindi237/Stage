...
@NgModule({
  declarations: [
    SupOverviewComponent, SupInfrastructureComponent, SupTraitementsComponent,
    SupJournauxComponent, SupAlertesComponent,
  ],
  imports: [
    ...
    MatInputModule, MatBadgeModule, MatExpansionModule, MatButtonToggleModule, MatSnackBarModule,
  ],
})
