...
@Component({
  ...
  styles: [`
    .cw { position:relative; height:180px; width:180px; margin:0 auto; }
    .center {
      position:absolute; top:50%; left:50%;
      transform:translate(-50%,-50%);
      text-align:center; pointer-events:none;
    }
    .val { display:block; font-size:1.6rem; font-weight:900; color:#000; line-height:1; }
    .lbl { display:block; font-size:0.7rem; font-weight:600; color:#9CA3AF; margin-top:2px; }
  `]
})
export class PlatformDonutChartComponent implements OnChanges, OnDestroy {
  ...
  get total(): number { return this.active + this.inactive; }
