...
BEGIN
    ...
    FROM (VALUES
        -- ── COURANT (cobac A) ─────────────────────────────────────────────
        ('CLF001','PRF001','YDE',450000,0,440000,0,0,180,'COURANT','A',0.00,'NANTISSEMENT',500000,'ACTIVE'),
        ('CLF002','PRF002','YDE',300000,0,290000,0,0,150,'COURANT','A',0.00,'CAUTION',0,'ACTIVE'),
        ('CLF003','PRF003','DLA',680000,0,665000,0,0,165,'COURANT','A',0.00,'NANTISSEMENT',800000,'ACTIVE'),
        ('CLF004','PRF004','YDE',520000,0,508000,0,0,175,'COURANT','A',0.00,'CAUTION',0,'ACTIVE'),
        ('CLF005','PRF005','DLA',390000,0,382000,0,0,155,'COURANT','A',0.00,'NANTISSEMENT',450000,'ACTIVE'),
        ('CLF006','PRF006','YDE',720000,0,705000,0,0,170,'COURANT','A',0.00,'CAUTION',0,'ACTIVE'),
        ('CLF007','PRF007','DLA',285000,0,278000,0,0,145,'COURANT','A',0.00,'NANTISSEMENT',320000,'ACTIVE'),
        ('CLF008','PRF008','YDE',950000,0,930000,0,0,185,'COURANT','A',0.00,'HYPOTHEQUE',1200000,'ACTIVE'),
        ('CLF009','PRF009','DLA',410000,0,401000,0,0,160,'COURANT','A',0.00,'NANTISSEMENT',480000,'ACTIVE'),
        ('CLF010','PRF010','YDE',560000,0,548000,0,0,172,'COURANT','A',0.00,'CAUTION',0,'ACTIVE'),
        ('CLF031','PRF031','YDE',380000,0,372000,0,0,140,'COURANT','A',0.00,'CAUTION',0,'ACTIVE'),
        ('CLF032','PRF032','YDE',250000,0,245000,0,0,130,'COURANT','A',0.00,'NANTISSEMENT',300000,'ACTIVE'),
        ('CLF033','PRF033','DLA',840000,0,822000,0,0,158,'COURANT','A',0.00,'NANTISSEMENT',950000,'ACTIVE'),
        ('CLF034','PRF034','DLA',650000,0,636000,0,0,152,'COURANT','A',0.00,'CAUTION',0,'ACTIVE'),
        ('CLF035','PRF035','YDE',320000,0,313000,0,0,135,'COURANT','A',0.00,'NANTISSEMENT',360000,'ACTIVE'),
        ('CLF036','PRF036','YDE',480000,0,469000,0,0,148,'COURANT','A',0.00,'CAUTION',0,'ACTIVE'),
        ('CLF037','PRF037','DLA',290000,0,284000,0,0,125,'COURANT','A',0.00,'NANTISSEMENT',330000,'ACTIVE'),
        ('CLF038','PRF038','DLA',580000,0,567000,0,0,155,'COURANT','A',0.00,'CAUTION',0,'ACTIVE'),
        ('CLF039','PRF039','YDE',220000,0,215000,0,0,118,'COURANT','A',0.00,'NANTISSEMENT',250000,'ACTIVE'),
        ('CLF040','PRF040','DLA',1100000,0,1076000,0,0,165,'COURANT','A',0.00,'HYPOTHEQUE',1500000,'ACTIVE'),
        -- ── PAR30 (cobac B) ───────────────────────────────────────────────
        ('CLF011','PRF011','YDE',500000,185000,312000,18500,7400,38,'PAR30','B',0.20,'CAUTION',0,'RECOUVREMENT_AMIABLE'),
        ('CLF012','PRF012','DLA',420000,168000,249000,16800,6720,45,'PAR30','B',0.20,'NANTISSEMENT',480000,'RECOUVREMENT_AMIABLE'),
        ('CLF013','PRF013','YDE',350000,132000,215000,13200,5280,35,'PAR30','B',0.20,'CAUTION',0,'RECOUVREMENT_AMIABLE'),
        ('CLF014','PRF014','DLA',780000,295000,478000,29500,11800,52,'PAR30','B',0.20,'NANTISSEMENT',900000,'RECOUVREMENT_AMIABLE'),
        ('CLF015','PRF015','YDE',460000,172000,283000,17200,6880,41,'PAR30','B',0.20,'CAUTION',0,'RECOUVREMENT_AMIABLE'),
        ('CLF016','PRF016','DLA',620000,233000,381000,23300,9320,48,'PAR30','B',0.20,'NANTISSEMENT',720000,'RECOUVREMENT_AMIABLE'),
        ('CLF041','PRF041','YDE',410000,148000,257000,14800,5920,37,'PAR30','B',0.20,'CAUTION',0,'RECOUVREMENT_AMIABLE'),
        ('CLF042','PRF042','DLA',540000,202000,334000,20200,8080,44,'PAR30','B',0.20,'CAUTION',0,'RECOUVREMENT_AMIABLE'),
        ('CLF043','PRF043','DLA',295000,108000,184000,10800,4320,32,'PAR30','B',0.20,'NANTISSEMENT',340000,'RECOUVREMENT_AMIABLE'),
        ('CLF044','PRF044','YDE',490000,183000,303000,18300,7320,39,'PAR30','B',0.20,'CAUTION',0,'RECOUVREMENT_AMIABLE'),
        -- ── PAR60 (cobac B/C) ─────────────────────────────────────────────
        ('CLF017','PRF017','YDE',680000,348000,325000,41760,16704,62,'PAR60','B',0.20,'HYPOTHEQUE',800000,'RECOUVREMENT_AMIABLE'),
        ('CLF018','PRF018','DLA',520000,265000,248000,31800,12720,71,'PAR60','C',0.50,'NANTISSEMENT',600000,'MISE_EN_DEMEURE'),
        ('CLF045','PRF045','DLA',750000,384000,358000,46080,18432,68,'PAR60','C',0.50,'NANTISSEMENT',850000,'MISE_EN_DEMEURE'),
        ('CLF046','PRF046','YDE',340000,174000,162000,20880,8352,65,'PAR60','B',0.20,'CAUTION',0,'RECOUVREMENT_AMIABLE'),
        ('CLF047','PRF047','DLA',490000,251000,234000,30120,12048,77,'PAR60','C',0.50,'NANTISSEMENT',560000,'MISE_EN_DEMEURE'),
        -- ── PAR90 (cobac C) ───────────────────────────────────────────────
        ('CLF019','PRF019','YDE',850000,612000,233000,73440,36720,95,'PAR90','C',0.50,'HYPOTHEQUE',950000,'MISE_EN_DEMEURE'),
        ('CLF020','PRF020','DLA',640000,461000,174000,55320,27660,108,'PAR90','C',0.50,'NANTISSEMENT',720000,'MISE_EN_DEMEURE'),
        ('CLF021','PRF021','YDE',570000,411000,153000,49320,24660,118,'PAR90','C',0.50,'CAUTION',0,'MISE_EN_DEMEURE'),
        ('CLF048','PRF048','YDE',620000,447000,168000,53640,26820,102,'PAR90','C',0.50,'NANTISSEMENT',700000,'MISE_EN_DEMEURE'),
        ('CLF049','PRF049','DLA',380000,274000,103000,32880,16440,115,'PAR90','C',0.50,'CAUTION',0,'MISE_EN_DEMEURE'),
        ('CLF050','PRF050','DLA',290000,209000,78000,25080,12540,125,'PAR90','C',0.50,'CAUTION',0,'MISE_EN_DEMEURE'),
        -- ── PAR180 (cobac D) ──────────────────────────────────────────────
        ('CLF022','PRF022','DLA',960000,835000,121000,125250,62625,185,'PAR180','D',0.80,'HYPOTHEQUE',1100000,'CONTENTIEUX'),
        ('CLF023','PRF023','YDE',720000,626000,90000,93900,46950,198,'PAR180','D',0.80,'NANTISSEMENT',800000,'CONTENTIEUX'),
        ('CLF051','PRF051','YDE',540000,470000,68000,70500,35250,210,'PAR180','D',0.80,'CAUTION',0,'CONTENTIEUX'),
        ('CLF052','PRF052','DLA',415000,361000,52000,54150,27075,195,'PAR180','D',0.80,'NANTISSEMENT',460000,'CONTENTIEUX'),
        ('CLF053','PRF053','YDE',480000,418000,60000,62700,31350,225,'PAR180','D',0.80,'CAUTION',0,'CONTENTIEUX'),
        -- ── PERTE (cobac E) ───────────────────────────────────────────────
        ('CLF024','PRF024','DLA',1200000,1200000,0,210000,105000,385,'PERTE','E',1.00,'HYPOTHEQUE',1300000,'IRRECOVERABLE'),
        ('CLF025','PRF025','YDE',880000,880000,0,154000,77000,412,'PERTE','E',1.00,'CAUTION',0,'IRRECOVERABLE'),
        ('CLF026','PRF026','DLA',650000,650000,0,113750,56875,395,'PERTE','E',1.00,'NANTISSEMENT',700000,'IRRECOVERABLE'),
        ('CLF027','PRF027','YDE',430000,430000,0,75250,37625,425,'PERTE','E',1.00,'CAUTION',0,'IRRECOVERABLE')
    ) AS c(cid, pret_id, agence, montant_initial, montant_impaye, capital_restant,
           interets, penalites, jours_deblocage, categorie_par, cobac,
    ...
    IF v_agent_id IS NOT NULL THEN
        INSERT INTO app.collectes_terrain
            (id_collecte_mobile, agent_id, imf_id, client_id,
